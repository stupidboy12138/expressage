...
Order.completeOrder = function(){
    ...
    location.href='http://localhost:8888/order/test1';
    var ajax = new $ax(Feng.ctxPath + "/order/test1", function (data) {
...
$(function () {
    ...
    var table = new BSTable(Order.id, "/order/exceptionalList", defaultColunms);
